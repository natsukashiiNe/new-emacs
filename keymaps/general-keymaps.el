  ...
  (add-hook
   ...
   (lambda ()
     ...
     (my-leader
       ...
       "f I" '(winner-redo     :which-key "next buffer")
       "f O" '(winner-undo     :which-key "next buffer")
...
(with-eval-after-load '(evil xref)
  (evil-define-key 'normal xref--xref-buffer-mode-map
    (kbd "S-j") #'xref-next-line
    (kbd "S-k") #'xref-prev-line))

;; vdiff
(with-eval-after-load '(evil vdiff)
...
(with-eval-after-load '(evil embark)
...
(with-eval-after-load '(evil flycheck)
...
(with-eval-after-load '(evil lsp-ui)
...
(with-eval-after-load '(evil devdocs)
